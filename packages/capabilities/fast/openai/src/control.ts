...
// https://learn.chatgpt.com/docs/agent-configuration/speed (checked 2026-09-23)
...
export const fastControl: RequestControl = {
  ...
  enabledNotice:
    "Fast requests service_tier=priority. ChatGPT credits: GPT-5.4 costs 2x; GPT-5.5/5.6/GPT-6 Astra/Sol/Luna cost 2.5x Standard where available. API token pricing is separate. Actual account billing/availability is backend-controlled.",
  ...
  transform: (payload, value) =>
    value === "on" && payload.service_tier !== "priority"
